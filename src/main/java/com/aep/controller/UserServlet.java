...
/**
 * UserServlet handles registration, login, and redirection flows.
 * Maps to "/user/*".
 */
@WebServlet("/user/*")
public class UserServlet extends HttpServlet {
    ...
    /**
     * DAO for interacting with the User table.
     */
...
//        new TeachRequestDAOImpl();
    }

    /**
     * Handles POST requests and routes actions based on the URL path.
     *
